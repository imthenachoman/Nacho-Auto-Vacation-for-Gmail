...
function card_buildHomepageCard()
{
    ...
    var mainSection = CardService.newCardSection()
        ...
        .addWidget(CardService.newDecoratedText()
            .setText((areJobsEnabled_ ? "Disable" : "Enable") + " Add-On")
